...
class ConsumerControllerTests {
	...
	public void getConsumerProperty() throws Exception {
			BusinessPropertyDetails businesssProperty=new BusinessPropertyDetails((long)1,(long)1,(long)1,"Fire","Building","string","Owner","string",(long)2,(long)10000,(long)5,(long)1);
		Mockito.when(consumerService.viewConsumerProperty(Mockito.anyLong())).thenReturn(businesssProperty);
