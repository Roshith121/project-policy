...
public class ConsumerServiceImpl implements ConsumerService {
	...
	@Override
	public BusinessPropertyDetails viewConsumerProperty(Long propertyid) {
		log.info("Start viewConsumerPropertyService");
		Optional<Property> property= Optional.ofNullable(propertyRepository.findById(propertyid).orElseThrow(()-> new BusinessPropertyNotFoundException() ));
		log.debug("Property list :{}",property);
		Property propertyObj = property.get();
		log.debug("property  : {}", property);
		BusinessPropertyDetails businessPropertyDetails = new BusinessPropertyDetails(propertyObj.getId(),propertyObj.getBusinessId(), propertyObj.getConsumerId(),propertyObj.getInsurancetype(), propertyObj.getPropertytype(),propertyObj.getBuildingsqft(), propertyObj.getBuildingtype(), propertyObj.getBuildingstoreys(), propertyObj.getBuildingage(),propertyObj.getCostoftheasset(), propertyObj.getSalvagevalue(), propertyObj.getUsefullifeoftheAsset());
		log.debug("Business property details :{}",businessPropertyDetails);
